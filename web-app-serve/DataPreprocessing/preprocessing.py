...
from DataPreprocessing.step1 import step1_python
import warnings
...
def full_prep(data_path,prep_folder,use_existing=True):
    ...
    for i in range(len(filelist)):
        savenpy(i, filelist = filelist, prep_folder = prep_folder, data_path = data_path, use_existing = use_existing)
...
def plot_ct_scan(scan):
    for i in range(0, scan.shape[0], 25):
